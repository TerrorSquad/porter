...
class MethodChannelMobileScanner extends MobileScannerPlatform {
  ...
  /// The name of the method that gets the available camera devices.
  @visibleForTesting
  ...
  ///
  /// Currently only supported on macOS, where it lists all connected
  /// `AVCaptureDevice`s (including external/USB cameras). Returns an empty
